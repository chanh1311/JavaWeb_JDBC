                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="heading1"
                        ...
                        <nav class="sb-sidenav-menu-nested nav">
                        	<c:url var="addURL" value="/admin-products">
                        		<c:param name="type" value="edit"></c:param>
                        		
                        	</c:url>
                        	
                        	
                            <a class="nav-link" href="<c:url value="/admin-products?type=list&page=1&maxPageItems=4&sortBy=MSHH&sortName=ASC"/>">Danh sách sản phẩm</a>
                            <a class="nav-link" href="${addURL}">Thêm sản phẩm</a>
